...
<head>
  ...
  <!--<link rel="icon" href="{{ asset('img/logo_3.png') }}">-->
  <link rel="icon" href="https://ucall.ng/mvno/public/img/logo_3.png">
  <title>Univasa</title>
                ...
                <table cellpadding="0" cellspacing="0" width="600" class="w320">
                  <tr>
                    <td style="vertical-align: middle;">
                      <a href="">
                        <!--<img width="200" height="47" src="{{ asset('img/logo_2.png') }}"  alt="logo">-->
                        <img width="200" height="47" src="https://ucall.ng/mvno/public/img/logo_2.png"  alt="logo">
                      </a>
                    </td>
                  </tr>
                </table>
                        ...
                        <td class="block-rounded">
                          <table cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                              <td class="info-img">
                                <a href="">
                                  <!--<img class="info-img" src="{{ asset('img/fintech.jpg') }}" alt="img"/>-->
                                  <img class="info-img" src="https://ucall.ng/mvno/public/img/fintech.jpg" alt="img"/>
                                </a>
                              </td>
                            </tr>
                            <tr>
                        ...
                        <td class="block-rounded">
                          <table cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                              <td class="info-img">
                                <a href="">
                                  <!--<img class="info-img" src="{{ asset('img/sim.jpg') }}" alt="img" />-->
                                  <img class="info-img" src="https://ucall.ng/mvno/public/img/sim.jpg" alt="img" />
                                </a>
                              </td>
                            </tr>
                            <tr>
